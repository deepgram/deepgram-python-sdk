...
class AgentV1SettingsAgentSpeakEndpointProvider_Deepgram(UncheckedBaseModel):
    type: typing.Literal["deepgram"] = "deepgram"
    version: typing.Optional[AgentV1SettingsAgentSpeakOneItemProviderDeepgramVersion] = None
...
class AgentV1SettingsAgentSpeakEndpointProvider_ElevenLabs(UncheckedBaseModel):
    type: typing.Literal["eleven_labs"] = "eleven_labs"
    version: typing.Optional[AgentV1SettingsAgentSpeakOneItemProviderElevenLabsVersion] = None
...
class AgentV1SettingsAgentSpeakEndpointProvider_Cartesia(UncheckedBaseModel):
    type: typing.Literal["cartesia"] = "cartesia"
    version: typing.Optional[AgentV1SettingsAgentSpeakOneItemProviderCartesiaVersion] = None
...
class AgentV1SettingsAgentSpeakEndpointProvider_OpenAi(UncheckedBaseModel):
    type: typing.Literal["open_ai"] = "open_ai"
    version: typing.Optional[AgentV1SettingsAgentSpeakEndpointProviderOpenAiVersion] = None
...
class AgentV1SettingsAgentSpeakEndpointProvider_AwsPolly(UncheckedBaseModel):
