...
class AgentV1SettingsAgentSpeakOneItemProvider_Deepgram(UncheckedBaseModel):
...
class AgentV1SettingsAgentSpeakOneItemProvider_ElevenLabs(UncheckedBaseModel):
...
class AgentV1SettingsAgentSpeakOneItemProvider_Cartesia(UncheckedBaseModel):
...
class AgentV1SettingsAgentSpeakOneItemProvider_OpenAi(UncheckedBaseModel):
    type: typing.Literal["open_ai"] = "open_ai"
    version: typing.Optional[AgentV1SettingsAgentSpeakOneItemProviderOpenAiVersion] = None
...
class AgentV1SettingsAgentSpeakOneItemProvider_AwsPolly(UncheckedBaseModel):
