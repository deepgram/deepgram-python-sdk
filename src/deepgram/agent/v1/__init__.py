...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "AgentV1SettingsAgentSpeakOneItemProviderCartesia": ".types",
    "AgentV1SettingsAgentSpeakOneItemProviderCartesiaModelId": ".types",
    "AgentV1SettingsAgentSpeakOneItemProviderCartesiaParams": ".requests",
    ...
    "AgentV1SettingsAgentSpeakOneItemProviderDeepgram": ".types",
    "AgentV1SettingsAgentSpeakOneItemProviderDeepgramModel": ".types",
    "AgentV1SettingsAgentSpeakOneItemProviderDeepgramParams": ".requests",
    "AgentV1SettingsAgentSpeakOneItemProviderElevenLabs": ".types",
    "AgentV1SettingsAgentSpeakOneItemProviderElevenLabsModelId": ".types",
    "AgentV1SettingsAgentSpeakOneItemProviderElevenLabsParams": ".requests",
