...
from ..types.agent_v1settings_audio_output_container import AgentV1SettingsAudioOutputContainer
...
class AgentV1SettingsAudioOutputParams(typing_extensions.TypedDict):
    ...
    container: typing_extensions.NotRequired[AgentV1SettingsAudioOutputContainer]
    """
