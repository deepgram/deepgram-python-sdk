...
AgentSocketClientResponse = typing.Union


class AsyncAgentSocketClient(EventEmitterMixin):
    ...
    async def __aiter__(self):
        async for message in self._websocket:
            yield parse_obj_as(AgentSocketClientResponse, json.loads(message))  # type: ignore
    ...
    async def start_listening(self):
        ...
        try:
            async for raw_message in self._websocket:
                ...
                parsed = parse_obj_as(AgentSocketClientResponse, json_data)  # type: ignore
    ...
    async def recv(self) -> AgentSocketClientResponse:
        """
        Receive a message from the websocket connection.
        """
        data = await self._websocket.recv()
        json_data = json.loads(data)
        return parse_obj_as(AgentSocketClientResponse, json_data)  # type: ignore
...
class AgentSocketClient(EventEmitterMixin):
    ...
    def recv(self) -> AgentSocketClientResponse:
        """
        Receive a message from the websocket connection.
        """
