...
SpeakSocketClientResponse = typing.Union


class AsyncSpeakSocketClient(EventEmitterMixin):
    ...
    async def __aiter__(self):
        async for message in self._websocket:
            yield parse_obj_as(SpeakSocketClientResponse, json.loads(message))  # type: ignore
    ...
    async def start_listening(self):
        ...
        try:
            async for raw_message in self._websocket:
                ...
                parsed = parse_obj_as(SpeakSocketClientResponse, json_data)  # type: ignore
    ...
    async def recv(self) -> SpeakSocketClientResponse:
        """
        Receive a message from the websocket connection.
        """
        data = await self._websocket.recv()
        json_data = json.loads(data)
        return parse_obj_as(SpeakSocketClientResponse, json_data)  # type: ignore
...
class SpeakSocketClient(EventEmitterMixin):
    ...
    def recv(self) -> SpeakSocketClientResponse:
        """
        Receive a message from the websocket connection.
        """
