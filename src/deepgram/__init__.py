...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "AgentVariableV1": ".types",
    "AgentVariableV1Params": ".requests",
    "Anthropic": ".types",
    "AnthropicParams": ".requests",
    "AnthropicThinkProviderModel": ".types",
    "AsyncDeepgramClient": ".client",
    "AsyncSixtyDbClient": ".sixty_db.client",
    ...
    "ListAgentConfigurationsV1ResponseParams": ".requests",
    "ListAgentVariablesV1Response": ".types",
    "ListAgentVariablesV1ResponseParams": ".requests",
    ...
    "SixtyDbAudioEncoding": ".types",
    "SixtyDbOutputFormat": ".types",
    "SixtyDbSampleRateHertz": ".types",
    "SixtyDbSpeakProvider": ".types",
    "SixtyDbSpeakProviderParams": ".requests",
    "SixtyDbSpeakProviderVoiceId": ".types",
    "SixtyDbStreamChunk": ".types",
    "SixtyDbStreamChunkResult": ".types",
    "SixtyDbStreamRequestParams": ".requests",
    "SixtyDbSynthesizeRequestParams": ".requests",
    "SixtyDbSynthesizeResponse": ".types",
    "SixtyDbWsAudioChunk": ".types",
    "SixtyDbWsAudioConfigParams": ".requests",
    "SixtyDbWsConnectionEstablished": ".types",
    "SixtyDbWsContextClosed": ".types",
    "SixtyDbWsContextCreated": ".types",
    "SixtyDbWsCreateContextParams": ".requests",
    "SixtyDbWsError": ".types",
    "SixtyDbWsEvent": ".types",
    "SixtyDbWsFlushCompleted": ".types",
    "SixtyDbWsSendTextParams": ".requests",
    ...
    "SpeakSettingsV1Provider_SixtyDb": ".types",
    "SpeakSettingsV1Provider_SixtyDbParams": ".requests",
