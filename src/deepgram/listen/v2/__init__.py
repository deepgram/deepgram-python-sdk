...
if typing.TYPE_CHECKING:
    from .types import ListenV2TurnInfo, ListenV2TurnInfoEvent, ListenV2TurnInfoWordsItem
    from .requests import ListenV2TurnInfoParams, ListenV2TurnInfoWordsItemParams
