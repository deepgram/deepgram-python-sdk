...
from .socket_client import AsyncListenSocketClient, ListenSocketClient
...
class RawListenClient:
        ...
        *,
    ...
    ) -> typing.Iterator[ListenSocketClient]:
        """
        ...
        try:
            with websockets_sync_client.connect(ws_url, additional_headers=headers) as protocol:
                yield ListenSocketClient(websocket=protocol)
...
class AsyncRawListenClient:
    ...
    async def connect(
        ...
        *,
        ...
        authorization: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> typing.AsyncIterator[AsyncListenSocketClient]:
        """
        Transcribe audio and video using Deepgram's speech-to-text WebSocket
        ...
        try:
            async with websockets_client_connect(ws_url, extra_headers=headers) as protocol:
                yield AsyncListenSocketClient(websocket=protocol)
        except websockets.exceptions.InvalidStatusCode as exc:
            status_code: int = exc.status_code
            if status_code == 401:
                raise ApiError(
