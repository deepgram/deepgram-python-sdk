...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "MediaTranscribeRequestModelZero": ".media",
    "MediaTranscribeRequestSummarizeZero": ".media",
    "MediaTranscribeRequestVersionZero": ".media",
