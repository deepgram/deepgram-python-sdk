...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "ListenV1ResultsMetadataDiarizeInfo": ".types",
    "ListenV1ResultsMetadataDiarizeInfoArch": ".types",
    "ListenV1ResultsMetadataDiarizeInfoParams": ".requests",
    ...
    "MediaTranscribeRequestDiarizeModel": ".media",
