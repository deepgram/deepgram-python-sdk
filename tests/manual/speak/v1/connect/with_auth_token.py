...
print("Starting speak v1 connect with auth token example script")
load_dotenv()
...
try:
    ...
    with client.speak.v1.connect(model=model, encoding=encoding, sample_rate=sample_rate) as connection:
