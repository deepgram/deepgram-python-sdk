...
print("Starting speak v1 audio generate with raw response example script")
load_dotenv()
...
try:
    ...
    print(f"Sending text-to-speech generation request with raw response - Text: {text[:50]}...")
