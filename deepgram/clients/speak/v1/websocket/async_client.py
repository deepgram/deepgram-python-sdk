...
class AsyncSpeakWSClient:  # pylint: disable=too-many-instance-attributes
    ...
    async def clear(self) -> bool:
        ...
        """
        self._logger.spam("AsyncSpeakStreamClient.clear ENTER")

        if self._exit_event.is_set():
            self._logger.notice("clear exiting gracefully")
            self._logger.debug("AsyncSpeakStreamClient.clear LEAVE")
            return False
        ...
        if not ret:
            ...
            self._logger.spam("AsyncSpeakStreamClient.clear LEAVE")
            return False
