...
try:
    ...
    print(
        f"Found {len(credentials.distribution_credentials) if credentials.distribution_credentials else 0} credentials"
    )
    ...
    if credentials.distribution_credentials:
        ...
        cred = client.self_hosted.v1.distribution_credentials.get(
            project_id=project_id, distribution_credentials_id=cred_id
        )
