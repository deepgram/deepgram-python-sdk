...
async def main():
    try:
        ...
        # get models
        myModelId = None
        listModels = await deepgram.asyncmanage.v("1").get_models()
        ...
        # get model
        listModel = await deepgram.asyncmanage.v("1").get_model(myModelId)
        ...
        # get project models
        myModelId = None
        listProjModels = await deepgram.asyncmanage.v("1").get_project_models(
            myProjectId
        )
        ...
        # get project model
        listProjModel = await deepgram.asyncmanage.v("1").get_project_model(
            myProjectId, myModelId
        )
