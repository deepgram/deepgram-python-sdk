...
def main():
    try:
        ...
        options.agent.speak.provider.type = "eleven_labs"
        options.agent.speak.provider.model = None
        options.agent.speak.provider.model_id = "eleven_multilingual_v2"
        options.agent.speak.endpoint = Endpoint()
        options.agent.speak.endpoint.url = "https://api.elevenlabs.io/v1/text-to-speech/pNInz6obpgDQGcFmaJgB/stream"
